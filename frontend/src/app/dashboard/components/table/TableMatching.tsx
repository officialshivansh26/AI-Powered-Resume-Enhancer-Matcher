...
const TableFAQ = (props: Props) => {
  ...
  console.log("Candidate Detail Data:", candidateDetailQuery.data)
  return (
    <>
      <ToastContainer
        position="top-right"
          ...
          {fetching ? (
            ...
            <>
              ...
              <div className="p-2">
                ...
                <p className="px-2 text-sm leading-6 text-gray-60">
                  Suggestion:{" "}
                  {candidateDetailQuery.data?.degree.suggestion}
                </p>
              </div>
              ...
              <div className="p-2">
                ...
                <p className="px-2 text-sm leading-6 text-gray-60">
                  Suggestion:{" "}
                  {candidateDetailQuery.data?.experience.suggestion
                    ? candidateDetailQuery.data?.experience.suggestion
                    : "None"}
                </p>
              </div>
              ...
              <div className="p-2">
                ...
                <p className="px-2 text-sm leading-6 text-gray-60">
                  Suggestion:{" "}
                  {candidateDetailQuery.data?.responsibility.suggestion
                    ? candidateDetailQuery.data?.responsibility.suggestion
                    : "None"}
                </p>
              </div>
              ...
              <div className="p-2">
                ...
                <p className="px-2 text-sm leading-6 text-gray-60">
                  Suggestion:{" "}
                  {candidateDetailQuery.data?.technical_skill.suggestion
                    ? candidateDetailQuery.data?.technical_skill.suggestion
                    : "None"}
                </p>
              </div>
              ...
              <div className="p-2">
                ...
                <p className="px-2 text-sm leading-6 text-gray-60">
                  Suggestion:{" "}
                  {candidateDetailQuery.data?.soft_skill.suggestion
                    ? candidateDetailQuery.data?.soft_skill.suggestion
                    : "None"}
                </p>
              </div>
              ...
              <div className="p-2">
                ...
                <p className="px-2 text-sm leading-6 text-gray-60">
                  Suggestion:{" "}
                  {candidateDetailQuery.data?.certificate.suggestion
                    ? candidateDetailQuery.data?.certificate.suggestion
                    : "None"}
                </p>
              </div>
