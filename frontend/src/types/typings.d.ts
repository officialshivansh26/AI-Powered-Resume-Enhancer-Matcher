...
interface MatchingDetailModel {
  ...
  degree: { score: number; comment: string; suggestion: string};
  experience: { score: number; comment: string; suggestion: string };
  responsibility: { score: number; comment: string; suggestion: string };
  soft_skill: { score: number; comment: string; suggestion: string };
  technical_skill: { score: number; comment: string; suggestion: string };
  certificate: { score: number; comment: string; suggestion: string };
}
